...
To try `pyjob` on your own experiments check Sections 2, to check how the "Hello World" example was built check Section 3, to use `pyjob` for distributed training, check Section 5. Once set up, with only one command you will be able to submit a set of jobs defined by a template:
